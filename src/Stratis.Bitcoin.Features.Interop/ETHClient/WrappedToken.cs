...
namespace Stratis.Bitcoin.Features.Interop.ETHClient2
{
    public class WrappedTokenDeployment : ContractDeploymentMessage
    {
        public static string BYTECODE = // TODO
        ...
        public WrappedTokenDeployment() : base(BYTECODE)
        {
        }
