...
namespace Stratis.Bitcoin.Features.Interop.ETHClient
{
    public interface IETHClient
    {
        ...
        /// <summary>
        /// Get the number of confirmations a transaction has on the chain, i.e. the number of blocks that have been produced since it was mined into a block.
        /// </summary>
        /// <param name="transactionHash">The hash of the transaction.</param>
        /// <returns>The number of confirmations and the block the transaction appears in.</returns>
