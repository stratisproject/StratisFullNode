...
namespace Stratis.Bitcoin.Features.Consensus.CoinViews
{
    ...
    public interface ICoindb
    {
        ...
        void SaveChanges(IList<UnspentOutput> unspentOutputs, Dictionary<TxDestination, Dictionary<uint, long>> balanceUpdates, HashHeightPair oldBlockHash, HashHeightPair nextBlockHash, List<RewindData> rewindDataList);
