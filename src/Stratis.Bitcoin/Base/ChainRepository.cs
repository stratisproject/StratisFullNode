        ...
        public Task SaveAsync(ChainIndexer chainIndexer)
        {
            ...
            Task task = Task.Run(() =>
            {
                using (var batch = new WriteBatch())
                {
                    ...
                    // TODO: This probably applies to LevelDB as well, need to make sure
                    ...
                    foreach (ChainedHeader block in orderedChainedHeaders)
                    {
                        ...
                        {
                            // Copy the header parameters, until we don't make PH a normal header we store it in its own repo.
