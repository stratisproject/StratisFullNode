...
namespace Stratis.SmartContracts.Tests.Common
{
    public class TestStraxMinting : StraxMinting
    {
                ...
                walletManager, asyncProvider, timeSyncBehaviorState, loggerFactory, minerSettings)
        {
            ...
            this.SetPrivatePropertyValue(typeof(PosMinting), nameof(PosMinting.StakeCancellationTokenSource), CancellationTokenSource.CreateLinkedTokenSource(new[] { nodeLifetime.ApplicationStopping }));
        }
    ...
    public sealed class StraxRunner : NodeRunner
    {
        ...
        public StraxRunner(string dataDir, Network network, EditableTimeProvider timeProvider)
            : base(dataDir, null)
        {
            this.Network = network;
