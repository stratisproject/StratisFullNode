...
namespace Stratis.Bitcoin.IntegrationTests
{
    public class NodeContext : IDisposable
    {
        ...
        public NodeContext(object caller, string name, Network network, bool clean)
        {
            ...
            this.Coindb = new LeveldbCoindb(network, this.FolderName, dateTimeProvider, this.loggerFactory, new NodeStats(dateTimeProvider), serializer);
        ...
        public void ReloadPersistentCoinView()
        {
            ...
            this.Coindb = new LeveldbCoindb(this.Network, this.FolderName, dateTimeProvider, this.loggerFactory, new NodeStats(dateTimeProvider), serializer);
