...
namespace Stratis.Bitcoin.IntegrationTests
{
    public class NodeContext : IDisposable
    {
        ...
        public void ReloadPersistentCoinView(Network network)
        {
            ...
            this.Coindb = new LeveldbCoindb(this.Network, this.FolderName, dateTimeProvider, this.loggerFactory, new NodeStats(dateTimeProvider, NodeSettings.Default(network), new Mock<IVersionProvider>().Object), serializer);
