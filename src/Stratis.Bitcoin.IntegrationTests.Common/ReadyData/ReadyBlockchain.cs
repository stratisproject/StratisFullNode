...
namespace Stratis.Bitcoin.IntegrationTests.Common.ReadyData
{
    ...
    public class ReadyBlockchain
    {
        ...
        public static string StratisRegTest10Miner = @"ReadyData/StraxRegTest10Miner.zip";
        public static string StratisRegTest10Listener = @"ReadyData/StraxRegTest10Listener.zip";
        public static string StratisRegTest10NoWallet = @"ReadyData/StraxRegTest10NoWallet.zip";
        ...
        public static string StratisRegTest150Miner = @"ReadyData/StraxRegTest150Miner.zip";
        public static string StratisRegTest150Listener = @"ReadyData/StraxRegTest150Listener.zip";
        public static string StratisRegTest150NoWallet = @"ReadyData/StraxRegTest150NoWallet.zip";
