...
namespace Stratis.SmartContracts.CLR.Tests
{
    public class MultiSigTests
    {
        ...
        public void CanAddAndRemoveMembers()
        {
            ...
            var testAddress = EmbeddedContractAddress.Create(typeof(MultiSig), 1).ToAddress();
            ...
            var authPersistentState = new PersistentState(context.PersistenceStrategy, context.Serializer, EmbeddedContractAddress.Create(typeof(Authentication), 1));
