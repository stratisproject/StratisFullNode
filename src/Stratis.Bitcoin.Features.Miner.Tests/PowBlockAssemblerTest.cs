    ...
    public class PowBlockAssemblerTest : LogsTestBase
    {
        ...
        public void CreateNewBlock_WithScript_ReturnsBlockTemplate()
        {
            this.ExecuteWithConsensusOptions(new ConsensusOptions(), () =>
            {
                ...
                var blockDefinition = new PowBlockDefinition(this.consensusManager.Object, this.dateTimeProvider.Object, this.txMempool.Object, new MempoolSchedulerLock(), this.minerSettings, this.testNet, this.consensusRules.Object, new NodeDeployments(this.testNet, chainIndexer));
        ...
        public void ComputeBlockVersion_UsingChainTipAndConsensus_NoBip9DeploymentActive_UpdatesHeightAndVersion()
        {
            this.ExecuteWithConsensusOptions(new ConsensusOptions(), () =>
            {
                ...
                var blockDefinition = new PowTestBlockDefinition(this.consensusManager.Object, this.dateTimeProvider.Object, this.txMempool.Object, new MempoolSchedulerLock(), this.minerSettings, this.testNet, this.consensusRules.Object, new NodeDeployments(this.testNet, chainIndexer));

                (int Height, int Version) result = blockDefinition.ComputeBlockVersion(chainIndexer.GetHeaderByHeight(4));
        ...
        public void AddTransactions_WithoutTransactionsInMempool_DoesNotAddEntriesToBlock()
        {
            ...
            this.ExecuteWithConsensusOptions(newOptions, () =>
            {
                ...
                this.consensusManager.Setup(c => c.Tip)
                    .Returns(chainIndexer.GetHeaderByHeight(5));
                var indexedTransactionSet = new TxMempool.IndexedTransactionSet();
                this.txMempool.Setup(t => t.MapTx)
                    .Returns(indexedTransactionSet);

                var blockDefinition = new PowTestBlockDefinition(this.consensusManager.Object, this.dateTimeProvider.Object, this.txMempool.Object, new MempoolSchedulerLock(),
                    this.minerSettings, this.testNet, this.consensusRules.Object, new NodeDeployments(this.testNet, chainIndexer));
        ...
        public void AddTransactions_TransactionNotInblock_AddsTransactionToBlock()
        {
            ...
            {
                ChainIndexer chainIndexer = GenerateChainWithHeight(5, this.testNet, this.key);
                this.consensusManager.Setup(c => c.Tip).Returns(chainIndexer.GetHeaderByHeight(5));
                Transaction transaction = CreateTransaction(this.testNet, this.key, 5, new Money(400 * 1000 * 1000), new Key(), new uint256(124124));
                var txFee = new Money(1000);
        ...
        private TxMempoolEntry[] SetupTxMempool(ChainIndexer chainIndexer, ConsensusOptions newOptions, Money txFee, params Transaction[] transactions)
        {
            ...
            {
                Height = 4,
                MaxInputBlock = chainIndexer.GetHeaderByHeight(4),
                Time = chainIndexer.GetHeaderByHeight(4).Header.Time
            };
        ...
        private class PowTestBlockDefinition : PowBlockDefinition
        {
            public PowTestBlockDefinition(
                ...
                : base(consensusLoop, dateTimeProvider, mempool, mempoolLock, minerSettings, network, consensusRules, nodeDeployments)
            {
