...
{
    public class SmartContractPoSBlockProvider : IBlockProvider
    {
        ...
        public SmartContractPoSBlockProvider(Network network, IEnumerable<BlockDefinition> definitions, ISmartContractActivationProvider smartContractPosActivationProvider)
        {
