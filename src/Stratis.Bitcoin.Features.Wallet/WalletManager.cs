...
namespace Stratis.Bitcoin.Features.Wallet
{
    ...
    public class WalletManager : IWalletManager
    {
        ...
        /// <inheritdoc />
        public IEnumerable<AccountHistory> GetHistory(string walletName, string accountName = null, string address = null, string searchQuery = null, int limit = int.MaxValue, int offset = 0)
        {
            Guard.NotEmpty(walletName, nameof(walletName));
            ...
            lock (this.lockObject)
            {
                ...
                {
                    accountsHistory.Add(this.GetHistoryForAccount(account, address, limit, offset, searchQuery));
                }
            }
        ...
        protected AccountHistory GetHistoryForAccount(HdAccount account, string address, int limit, int offset, string searchQuery = null)
        {
            ...
            lock (this.lockObject)
            {
               return this.WalletRepository.GetHistory(account, address, limit, offset, searchQuery);
            }
        }
