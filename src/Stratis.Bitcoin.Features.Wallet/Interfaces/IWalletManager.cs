...
namespace Stratis.Bitcoin.Features.Wallet.Interfaces
{
    ...
    public interface IWalletManager
    {
        ...
        IEnumerable<AccountHistory> GetHistory(string walletName, string accountName = null, string searchQuery = null, int limit = int.MaxValue, int offset = 0, bool forSmartContracts = false);
