    ...
    public class CirrusTest : PoANetwork
    {
        public CirrusTest()
        {
            ...
            var bip9Deployments = new CirrusBIP9Deployments()
            {
                ...
                [CirrusBIP9Deployments.Release1210] = new BIP9DeploymentsParameters("Release1210", 0, 0 /* Voting starts immediately */, DateTime.Parse("2023-1-1").ToUnixTimestamp(), BIP9DeploymentsParameters.DefaultMainnetThreshold)
            };
