    ...
    public sealed class CirrusDev : PoANetwork
    {
        ...
        public CirrusDev()
        {
            ...
            var bip9Deployments = new CirrusBIP9Deployments()
            {
                ...
                [CirrusBIP9Deployments.Release1210] = new BIP9DeploymentsParameters("Release1210", 0, 0 /* Voting starts immediately */, DateTime.Now.AddDays(50).ToUnixTimestamp(), BIP9DeploymentsParameters.DefaultMainnetThreshold)
            };
