...
namespace Stratis.Features.FederatedPeg.TargetChain
{
    public class WithdrawalTransactionBuilder : IWithdrawalTransactionBuilder
    {
        ...
        private TransactionBuildContext CreateContext(int blockHeight, uint256 depositId, uint blockTime, Recipient recipient)
        {
        ...
        public Transaction BuildWithdrawalTransaction(int blockHeight, uint256 depositId, uint blockTime, Recipient recipient, List<Recipient> multiSigRecipients)
        {
            try
            {
                TransactionBuildContext multiSigContext = CreateContext(blockHeight, depositId, blockTime, recipient);

                multiSigContext.Recipients = multiSigRecipients;
